...
require get_template_directory() . '/inc/shortcodes/service.php';
require get_template_directory() . '/inc/shortcodes/service-relate.php';
require get_template_directory() . '/inc/shortcodes/technology.php';
require get_template_directory() . '/inc/shortcodes/technology-relate.php';
