...
if ( get_theme_mod( 'fl_service', 1 ) ) {
  require_once __DIR__ . '/shortcodes/ux_service.php';
}

if ( get_theme_mod( 'fl_technology', 1 ) ) {
  require_once __DIR__ . '/shortcodes/ux_technology.php';
}
