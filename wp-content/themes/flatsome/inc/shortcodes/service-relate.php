...
function flatsome_service_relate_shortcode($atts, $content = null, $tag) {
  ...
  if(!$style) $style = flatsome_option('service_style');

  // Fix old
  if($tag == 'service_slider') $type = 'slider';
 ...
 if($filter && $filter != 'disabled' && empty($cat) && $type !== 'grid' && $type !== 'slider' && $type !== 'full-slider'){
  ...
  <ul class="nav nav-<?php echo $filter;?> nav-<?php echo $filter_align ;?> nav-<?php echo $filter_nav;?> nav-uppercase filter-nav">
    ...
    <?php
      $tax_terms = get_terms('service_category');
 ...
 ?>
  <?php
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
          ...
          ?>
          <div class="<?php echo implode(' ', $classes_col); ?>" data-id="<?php  echo strip_tags( get_the_term_list( get_the_ID(), 'service_category', "",", " ) );?>" <?php echo $animate; ?>>
                  ...
                  <div class="box-text-inner">
                      ...
                      <p class="uppercase portfolio-box-category is-xsmall op-6">
                        ...
                        <span class="show-on-hover">
                            <?php  echo strip_tags( get_the_term_list( get_the_ID(), 'service_category', "",", " ) );?>
                        </span>
                      </p>
                  </div><!-- box-text-inner -->
            </div><!-- box-text -->
...
add_shortcode("service_slider_relate", "flatsome_service_relate_shortcode");
add_shortcode("service_grid_relate", "flatsome_service_relate_shortcode");
add_shortcode("ux_service_relate", "flatsome_service_relate_shortcode");
