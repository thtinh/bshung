...
function flatsome_service_shortcode($atts, $content = null, $tag) {
...
add_shortcode("service_slider", "flatsome_service_shortcode");
add_shortcode("service_grid", "flatsome_service_shortcode");
add_shortcode("ux_service", "flatsome_service_shortcode");
