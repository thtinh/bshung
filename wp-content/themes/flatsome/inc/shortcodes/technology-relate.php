...
function flatsome_technology_relate_shortcode($atts, $content = null, $tag) {
...
add_shortcode("technology_relate_slider", "flatsome_technology_relate_shortcode");
add_shortcode("technology_relate_grid", "flatsome_technology_relate_shortcode");
add_shortcode("ux_technology_relate", "flatsome_technology_relate_shortcode");
