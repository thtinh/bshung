...
function flatsome_technology_shortcode($atts, $content = null, $tag) {
  ...
  if(!$style) $style = flatsome_option('technology_style');

  // Fix old
  if($tag == 'technology_slider') $type = 'slider';
 ...
 if($filter && $filter != 'disabled' && empty($cat) && $type !== 'grid' && $type !== 'slider' && $type !== 'full-slider'){
  ...
  <ul class="nav nav-<?php echo $filter;?> nav-<?php echo $filter_align ;?> nav-<?php echo $filter_nav;?> nav-uppercase filter-nav">
    ...
    <?php
      $tax_terms = get_terms('technology_category');
 ...
 ?>
  <?php
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
          ...
          ?>
        <div class="<?php echo implode(' ', $classes_col); ?>" data-id="<?php  echo strip_tags( get_the_term_list( get_the_ID(), 'technology_category', "",", " ) );?>" <?php echo $animate; ?>>
            <div class="col-inner" <?php echo get_shortcode_inline_css($css_col); ?>>
                <?php /* <a href="<?php echo $link; ?>" class="plain <?php echo $has_lightbox; ?>"> */ ?>
                        ...
                        <div class="<?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css( $css_args ); ?>>
                            <div class="box-text-inner">
                                <a href="<?php echo $link; ?>">
                                    <h6 class="portfolio-box-title"><?php the_title(); ?></h6>
                                </a>
                                <?php
                                /*
                                <p class="portfolio-box-category is-xsmall op-6">
                                    <span class="show-on-hover">
                                        <?php  echo strip_tags( get_the_term_list( get_the_ID(), 'technology_category', "",", " ) );?>
                                    </span>
                                </p>
                                */ ?>
                                <div class="excerpt">
                                ...
                                <div class="readmore">
                                    <a href="<?php echo $link; ?>">Xem thêm <span class="meta-nav">&rarr;</span></a>
                                </div>
                            </div><!-- box-text-inner -->
                        </div><!-- box-text -->
                    </div><!-- .box  -->
...
add_shortcode("technology_slider", "flatsome_technology_shortcode");
add_shortcode("technology_grid", "flatsome_technology_shortcode");
add_shortcode("ux_technology", "flatsome_technology_shortcode");
