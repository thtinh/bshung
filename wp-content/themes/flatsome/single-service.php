...
<div class="portfolio-page-wrapper portfolio-single-page">
			...
			<div class="large-3 col"  role="main">
				<div class="main-sidebar">
					<div id="service-sidebar">
						<h4 class="service-sidebar-title">Thẩm mỹ da</h4>
	...
	<div class="portfolio-bottom">
		...
		echo do_shortcode( '<div class="portfolio-related large-9 col pb-0">[ux_service image_height="' . $height . '" class="portfolio-related" exclude="' . get_the_ID() . '" cat="' . $term_id . '"]</div>' );
		?>
		</div>
	</div>
