<div class="page-title portfolio-featured-title featured-title no-overflow">
	...
	<div class="page-title-bg">
		...
		<?php if(get_theme_mod('technology_archive_bg')) echo 'style="background-image:url('.do_shortcode(get_theme_mod('technology_archive_bg')).')"'; ?>>
		</div>
	...
	<div class="page-title-inner container  flex-row  dark">
	 	<div class="flex-col flex-grow">
	 		<?php do_action('flatsome_technology_title_left'); ?>
	 	</div>
	 	<div class="flex-col flex-center text-center" data-parallax="-1" data-parallax-fade="true">
			...
			<?php do_action('flatsome_technology_title_after'); ?>
	 	</div>
	 	<div class="flex-col flex-grow text-right">
			<?php do_action('flatsome_technology_title_right'); ?>
	 	</div>
	</div><!-- flex-row -->
</div><!-- .page-title -->
