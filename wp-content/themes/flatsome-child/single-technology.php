			...
			<div class="large-3 col"  role="main">
				<div class="main-sidebar">
					<div id="technology-sidebar">
						...
						?>
						<h4 class="technology-sidebar-title"><?php echo $name; ?></h4>
						<?php
							$post_args = array(
							      'posts_per_page' => -1,
			...
			<div id="portfolio-content" class="large-9 col"  role="main">
				...
				<div class="relate-technology">
					...
					<?php
						...
						echo do_shortcode( '<div class="portfolio-related col pb-0">[ux_technology_relate image_height="' . $height . '" class="portfolio-related" exclude="' . get_the_ID() . '" cat="' . $term_id . '"]</div>' );
					?>
				</div>
